...
EJSRequire _ejs_require_map[1] = { 0 };
EJSExternalModuleRequire _ejs_external_module_require_map[1] = { 0 };
...
{
    _ejs_require = _ejs_function_new_without_proto (_ejs_null, _ejs_atom_require, _ejs_require_impl);
