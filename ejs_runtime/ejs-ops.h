...
ejsval _ejs_op_div (ejsval lhs, ejsval rhs);
...
EJSBool _ejs_op_strict_eq (ejsval lhs, ejsval rhs);
EJSBool _ejs_op_strict_neq (ejsval lhs, ejsval rhs);
EJSBool _ejs_op_eq (ejsval lhs, ejsval rhs);
...
ejsval CheckIterable (ejsval obj);
